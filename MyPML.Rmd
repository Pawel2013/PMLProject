...
For random forests model with all 52 selected features we get slightly better accuracy 99,42% and coresponding unbiased estimation for out-of-sample error amounts to  0,578%.
